  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        // Soft Sculptural Design - Clay Press Buttons
        clay:
          "btn-clay text-primary-foreground font-semibold tracking-wide",
        "clay-secondary":
          "btn-clay-secondary text-foreground font-semibold tracking-wide",
        "clay-outline":
          "btn-clay-outline text-primary font-semibold tracking-wide",
      },
      size: {
        default: "h-9 px-4 py-2 has-[>svg]:px-3",
        sm: "h-8 gap-1.5 px-3 has-[>svg]:px-2.5",
        lg: "h-12 px-8 has-[>svg]:px-6 text-base",
        xl: "h-14 px-10 has-[>svg]:px-8 text-base",
        icon: "size-9",
        "icon-sm": "size-8",
        "icon-lg": "size-10",
      },
